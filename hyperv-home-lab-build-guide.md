...
1. [Hyper-V Home Lab Build Guide](#hyper-v-home-lab-build-guide)
   1. [Table of Contents](#table-of-contents)
   1. [Prerequisites](#prerequisites)
   1. [Conventions](#conventions)
   1. [Phase 1 — Hyper-V Infrastructure](#phase-1--hyper-v-infrastructure)
      1. [1. Create a virtual switch](#1-create-a-virtual-switch)
      1. [2. Create the domain controller VMs](#2-create-the-domain-controller-vms)
      1. [3. VM Networking Config](#3-vm-networking-config)
      1. [4. Rename and Restart VMs](#4-rename-and-restart-vms)
      1. [5. Enable Basic Connectivity and Remote Management](#5-enable-basic-connectivity-and-remote-management)
   1. [Phase 2 — Active Directory and DNS Deployment](#phase-2--active-directory-and-dns-deployment)
      1. [0. Variables](#0-variables)
      1. [1. DC01 Setup (Forest Root)](#1-dc01-setup-forest-root)
         1. [Networking](#networking)
         1. [Install Roles](#install-roles)
         1. [Create Forest](#create-forest)
         1. [DNS Configuration](#dns-configuration)
      1. [2. DC02 Setup (Additional DC)](#2-dc02-setup-additional-dc)
         1. [Networking](#networking-1)
         1. [Install Roles](#install-roles-1)
         1. [Promote as Domain Controller](#promote-as-domain-controller)
      1. [3. Finalize DNS](#3-finalize-dns)
         1. [DC DNS Client Settings](#dc-dns-client-settings)
         1. [Confirm Domain Records](#confirm-domain-records)
      1. [4. Sites and Subnets](#4-sites-and-subnets)
      1. [5. Health and Replication Checks](#5-health-and-replication-checks)
      1. [Post-Install Hardening](#post-install-hardening)
      1. [Optional: DHCP and Client Join](#optional-dhcp-and-client-join)
         1. [Client Join (PowerShell as Administrator)](#client-join-powershell-as-administrator)
      1. [Optional: NAT Port Mapping](#optional-nat-port-mapping)
      1. [Optional: Backup](#optional-backup)
   1. [End State](#end-state)
   1. [Troubleshooting Quick Hits](#troubleshooting-quick-hits)
